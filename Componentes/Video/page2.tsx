...
export const Page2 = () => {
  ...
  return (
    <S.Container>
      ...
      <S.Paragrafo>
        <p>
           Somos uma empresa de treinamento personalizado que tem como objetivo levar saúde até você, no local que desejar, para aulas individuais ou em grupo. 
           ...
           Possuímos uma metodologia com treinos dinâmicos e individualizados para cada um de nossos alunos, valorizando a consistência e ajudando você a manter um estilo de vida saudável a longo prazo.
        </p>
      </S.Paragrafo>
    </S.Container>
  );
